...
export default function Card({ item, collectionName, HasPage }) {
  ...
  return (
    <li className="card xl:min-h-[30vh] w-full text-left p-[var(--spacing-2xl)] md:p-[var(--spacing-3xl)] box-shadow-primary text-text bg-bg max-w-full md:max-w-6/12 h-auto flex flex-col justify-center">
